...
const IncidenceDetailPage = () => {
  ...
  const handleDelete = async () => {
    // Confirm deletion
    if (!window.confirm('Are you sure you want to delete this incidence report? This action cannot be undone.')) {
      return;
    }
    ...
    try {
      ...
      // Redirect to incidence list with success message
      navigate('/incidence', { state: { deleteSuccess: true } });
    } catch (error) {
