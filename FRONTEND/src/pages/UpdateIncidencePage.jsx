  ...
  return (
    <div className="min-h-screen bg-base-200 py-10 px-4">
      <div className="max-w-3xl mx-auto bg-base-100 rounded-xl shadow-md p-6">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-base-content mb-2">Update Incidence Report</h1>
          <p className="text-base-content/70">Update the details about this incident below.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              disabled
            />
            <p className="text-xs text-base-content/50 mt-1">Reporter name cannot be changed</p>
          </div>
