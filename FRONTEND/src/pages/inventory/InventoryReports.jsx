  ...
  return (
    <div className="min-h-screen bg-base-200">
      <div className="max-w-6xl mx-auto p-4">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-base-content">Inventory Reports</h1>
          <p className="text-base-content/60">Generate comprehensive PDF reports for Tools and FNI (Fertilizers & Insecticides) inventory systems.</p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          {/* Tools Management Report */}
          <div className="bg-base-100 p-6 rounded-lg shadow border border-base-content/10">
            <div className="flex items-center mb-4">
              <div className="w-12 h-12 rounded-full bg-orange-900 text-orange-200 flex items-center justify-center mr-4">
                <Wrench className="w-6 h-6" />
              </div>
              <div>
                <h2 className="text-xl font-semibold text-base-content">Tools Management Report</h2>
                <p className="text-base-content/60 text-sm">Complete tools inventory and statistics</p>
              </div>
            </div>
            <p className="text-base-content/60 mb-6">Generate a comprehensive PDF report including all tools inventory, availability status, worker assignments, condition status, and retirement records.</p>
            <button 
          ...
          <div className="bg-base-100 p-6 rounded-lg shadow border border-base-content/10">
            <div className="flex items-center mb-4">
              ...
              <div>
                <h2 className="text-xl font-semibold text-base-content">FNI Management Report</h2>
                <p className="text-base-content/60 text-sm">Fertilizers & Insecticides inventory</p>
              </div>
            </div>
            <p className="text-base-content/60 mb-6">Generate a detailed PDF report with all items including fertilizers and insecticides, stock quantities, batch information, and total inventory value in LKR.</p>
            <button 
        ...
        {/* Information Section */}
        <div className="bg-base-100 rounded-lg shadow border border-base-content/10 p-6">
          <div className="text-center">
            <BarChart2 className="w-16 h-16 text-base-content/60 mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-base-content mb-2">PDF Report Generation</h3>
            <p className="text-base-content/60 max-w-2xl mx-auto mb-6">
