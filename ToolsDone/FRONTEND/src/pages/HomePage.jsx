      ...
      <div className="relative z-10">
        ...
        <section className="flex flex-col items-center justify-center h-[80vh] text-center px-6">
          ...
          <div className="flex items-center gap-3 mt-10 animate-fade-in-slow">
            ...
            <button
              className="btn btn-ghost text-white border-white/30 hover:border-white px-6"
              onClick={() => {
        ...
        {/* FOOTER */}
        <footer className="border-t border-white/10/10 bg-black/30 backdrop-blur">
          <div className="mx-auto max-w-6xl px-6 py-8 flex flex-col md:flex-row items-center justify-between text-white/80">
            <div className="flex items-center gap-3">
              <img src="favicon.png" alt="CeylonLeaf" className="w-7 h-7" />
              <span className="font-semibold">CeylonLeaf</span>
            </div>
            <p className="text-sm mt-3 md:mt-0">
              © {new Date().getFullYear()} CeylonLeaf. Tea made simpler.
            </p>
          </div>
        </footer>
      </div>
